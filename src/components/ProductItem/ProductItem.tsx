    ...
    return (
      <div className="container mx-auto" data-testid="product-item">
        <div className="border my-1 py-2 px-6 rounded flex flex-col items-center mb-2 h-64">
          ...
          <p className="font-bold text-xl px-2">{this.props.product.price}$</p>
          <p className="text-gray-400 text-sm">{this.props.product.category}</p>

          <div className="px-1 py-2">
            <FontAwesomeIcon icon={['fas', 'calendar-days']} />
            <span className="px-1 text-sm font-semibold text-blue-700">
              {this.props.product.date?.toLocaleDateString()}
            </span>

            <span
              className={
                this.props.product.sale === true ? 'text-green-600 px-3' : 'text-gray-300 px-3'
              }
            >
            ...
            <span
              className={
                this.props.product.notification === true ? 'text-green-600' : 'text-gray-300'
              }
            >
